...
export default function FormProduct() {
  ...
  const validate = (p) => {
    ...
    if (!p.image || !regexURL.test(p.image))
      errors.image = "Debe introducir un url válido";
  ...
  function handleRemoveImg(imgObj) {
    ...
    axios.delete(`http://localhost:3001/${imgObj}`).then(() => {
      setImages({})
      setImageToRemove("");
    });
  }
  ...
  return (
    <div className={style.formContainer}>
      <div className={style.containerImageDetail}>
        <div className={style.divImageProduct}>
          ...
          <div className={style.divButton}>
            ...
            <button className={style.imageButton} onClick={()=> handleRemoveImg(images.public_id)}>Eliminar</button>
      ...
      <button className={style.imageButton}>Subir producto</button>
